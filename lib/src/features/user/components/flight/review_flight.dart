                  ...
                  children: [
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        ...
                        Icon(
                          flightData['refundable'] ? Icons.check_circle_outline : Icons.not_interested,size: 17,
                        ),
                      ],
                    ),
                    SizedBox(height: 2,),
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        ...
                        Icon(
                          flightData['insurance'] ? Icons.check_circle_outline : Icons.not_interested,size: 17,
                        ),
                      ],
                    ),
                  ],
                ...
                Text(
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      ...
                      Text(
                        flightData['refundable'] ? 'Refundable' : 'Partially Refundable',
                        style: GoogleFonts.ubuntu(
                          fontSize: 13,
                          fontWeight: FontWeight.w400,
