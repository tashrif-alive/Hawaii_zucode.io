...
class TicketConfirmationScreen extends StatelessWidget {
  ...
  TicketConfirmationScreen(
      {super.key, required this.flightData, required this.seatInfo, required this.seatBookText, required this.user});
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      '${flightData['fromTime']}',
                                      style: GoogleFonts.ubuntu(fontSize: 15, fontWeight: FontWeight.w300),
                                    ),
                                    Text(
                                      '${flightData['fromPlace']}',
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: GoogleFonts.ubuntu(
                                fontSize: 13,
                                fontWeight: FontWeight.w400,
                                color: flightData['refundable'] ? Colors.green : Colors.red,
                              ),
                            ),
                          ],
                        ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              "$seatBookText",
                              style: GoogleFonts.ubuntu(fontSize: 13, fontWeight: FontWeight.w500),
                            ),
                          ],
                        ),
                      ),
