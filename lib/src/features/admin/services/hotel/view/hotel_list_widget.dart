...
class HotelListScreenWidget extends StatefulWidget {
  const HotelListScreenWidget({Key? key});

  @override
  State<HotelListScreenWidget> createState() => _HotelListScreenWidgetState();
}

class _HotelListScreenWidgetState extends State<HotelListScreenWidget> {
